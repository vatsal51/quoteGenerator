...
function App() {
  ...
  useEffect(() => {
    ...
    const handleSwipeAndKeyPress = (event) => {
    ...
    document.addEventListener("touchstart", handleSwipeAndKeyPress);
    document.addEventListener("touchmove", handleSwipeAndKeyPress);
    document.addEventListener("touchend", handleSwipeAndKeyPress);
    document.addEventListener("keydown", handleSwipeAndKeyPress);

    return () => {
      document.removeEventListener("touchstart", handleSwipeAndKeyPress);
      document.removeEventListener("touchmove", handleSwipeAndKeyPress);
      document.removeEventListener("touchend", handleSwipeAndKeyPress);
      document.removeEventListener("keydown", handleSwipeAndKeyPress);
    };
  }, []);
  useEffect(() => {
            ...
            {!isLoggedIn ? (
              ...
              <>
                <div className="quote-header">
                  ...
                  <span title={`${user.name} logged in`} className="userName">
                    <span>
                      <svg
