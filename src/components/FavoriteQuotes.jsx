...
function FavoriteQuotes({ favorites, removeFromFav, setFavorites }) {
  ...
  const handleEdit = (e) => {
    ...
    const isEditBtnClicked =
      targetClassList.contains("editBtn") || e.target.closest(".editBtn");
  ...
  return (
    <div className="favourites w100p">
      <div className="rel inner-wrapy clearfix glass container">
        <span
          onClick={closeFav}
          title="close favourite's"
          className="close-fav icon"
        >
          <svg
              ...
              <div className="" key={index}>
                {editIndex === index ? (
                  ...
                  <div className="fav-edit" onClick={(e) => handleEdit(e)}>
                    ...
                    <button className="editBtn" title="edit quotes">
